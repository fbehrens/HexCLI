#!/usr/bin/env bun
/**
 * Non-interactive changeset creator for AI agents and scripts.
 *
 * Usage:
 *   bun run tools/add-changeset.ts <type> <summary>
 *
 * Example:
 *   bun run tools/add-changeset.ts patch "Fix clipboard timing"
 *   bun run tools/add-changeset.ts minor "Add new feature"
 */
